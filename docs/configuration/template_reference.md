...
* Prometheus templating language
  * -- based on -- [Go templating](https://golang.org/pkg/text/template/) system
  * allowed |
    * annotations
    * labels of alerts,
    * served console pages
  * allows
    * run queries -- against the -- local database
    * iterate -- over -- data
    * use conditionals
    * format data
    * etc
